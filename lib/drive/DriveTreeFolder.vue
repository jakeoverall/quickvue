  ...
  <div class="directory-content">
    <QCollapse :open="isRoot">
      <template #trigger="{show}">
        <div class="d-flex mb-1 align-items-center" @click="selectDirectory(folder)" dropzone="files" @dragover.prevent @drop.prevent="moveFiles(folder)">
          <QBtn class="p-0">
            <QIcon :icon="show ? 'mdi-chevron-right mdi-rotate-90' : 'mdi-chevron-right'" />
          </QBtn>
          <div class="d-flex align-items-center selectable" @click="selectDirectory(folder,show)">
      ...
      <div class="directory-content border-left pl-2 ml-3">
        <div class="directories">
          <div class="nested" v-for="directory in folder.folders" :key="directory.path">
            <DriveTreeFolder @selectDirectory="selectDirectory"
        ...
        <div class="files" v-if="selectedDirectory.path === folder.path">
          <div v-for="file in folder.files"
               ...
               @click="selectFile(file);hilightFile(file)"
